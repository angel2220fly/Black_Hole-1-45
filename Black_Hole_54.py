...
if os.path.basename(sys.argv[0]) != "Black_Hole_54.py":
    sys.exit("This is not 'Black_Hole_54.py'.")

print("The script 'Black_Hole_54.py' is currently running.")
                                                    ...
                                                    if num < 0:
                                                        ...
                                                        if last_binary:
                                                            ...
                                                            if (
                                                                ...
                                                                elif count_number+1664==num_c:
                                                                	count_number=count_number+1664
                                                                	IFC = (
                                                                    "10"+"1"
                                                                    + length_tree_after2
                                                                    + binary_representation
                                ...
                                while Extract1 != 1:
                                    ...
                                    while block < long_F:
                                        ...
                                        if INFO[block : block + 3] == "111":
                                        	...
                                        	if find_c_v!=4:
	                                            if INFO[block:block+3]=="000":
	                                            	find_c_v=1#384
	                                            	CN=0
	                                            	block+=3
	                                            elif INFO[block:block+3]=="001":
	                                            	find_c_v=3#896
	                                            	CN=1
	                                            	block+=3                                          	
	                                            elif INFO[block:block+3]=="010":
	                                            	find_c_v=2#256
	                                            	CN=2
	                                            	block+=3
	                                            elif INFO[block:block+3]=="011":
	                                            	find_c_v=0#0
	                                            	CN=3
	                                            	block+=3
	                                            	
	                                            elif INFO[block:block+3]=="100":
	                                            	find_c_v=5
	                                            	CN=4
	                                            	block+=3	    
	                                            	
	                                            elif INFO[block:block+3]=="101":
	                                            	find_c_v=6
	                                            	CN=5
	                                            	block+=3	    	                                            	                                        	
	                                            elif INFO[block:block+3]=="110":
	                                            	find_c_v=7
	                                            	CN=6
	                                            	block+=3	   	                                            	                                        	                                        	                                        	
